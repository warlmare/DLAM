...
training_data_normal = read_csv_to_list("dataset/normal_hashes_training_25k_pdf_ssdeep.csv")
...
training_data_anom = read_csv_to_list("dataset/anomaly_hashes_training_25k_pdf_ssdeep.csv")
...
max_steps = 50000 #The dataset size is 50000 but the dataset size is 30000
...
test_data_normal = read_csv_to_list("dataset/normal_hashes_test_2500_pdf_ssdeep.csv")
test_data_anomaly = read_csv_to_list("dataset/anomaly_hashes_test_2500_pdf_ssdeep.csv")
...
model = torch.load("trained_tiny_bert_model.pth")
model.eval()
...
def toy_result_check_bool(list_x):
...
toy_result_check(train_dataset.__getitem__(27001))
toy_result_check(train_dataset.__getitem__(2))
toy_result_check(train_dataset.__getitem__(700))
toy_result_check(train_dataset.__getitem__(27004))
toy_result_check(test_dataset.__getitem__(27))
toy_result_check(test_dataset.__getitem__(28))
toy_result_check(test_dataset.__getitem__(29))
toy_result_check(test_dataset.__getitem__(30))
...
for data in test_dataset:
  total += 1
  if toy_result_check_bool(data) is True:
    correct += 1
